...
//TextView uname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*uname = (TextView) findViewById(R.id.username_loged);
    ...
    public void loginBut(View view){
        Intent intent = new Intent(LogedIn.this, LoginActivity.class);
        startActivity(intent);
    }
    public void regBut(View view){
        Intent intent = new Intent(LogedIn.this, Registration.class);
        startActivity(intent);
    }
